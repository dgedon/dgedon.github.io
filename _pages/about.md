...
My research is fairly diverse.
 -->
Generally, I aim to build machine learning tools for scientific discovery.
I try to understand machine learning algorithms through theory and empirical observations to then build rigorously grounded methods to solve scientific problems.
...
(1) systems pharmacology models, with focus on chronic kidney disease,and
(2) for automated evaluation of electrocardiogram (ECG) recordings.

---
## Background
- Currently: Postdoctoral fellow at Tübingen University, Germany.
- 2024: Ph.D. in deep learning at Uppsala University, Sweden.
- 2019: M.Sc. in systems and control at TU Delft, the Netherlands.
- 2015: B.Sc. in aerospace engineering at DHBW, Germany.
- 1994: born.
